...
class RobotParamSrv(Node):
    def __init__(self, node_name):
        ...
        self.declare_parameter(name="sample_timer", value = 0.0, Descriptor = ParameterDescriptor(descrition="Cinifiguracion del timer de muestreo"))
    ...
    def on_set_params_callback(self, params:list[Parameter]):
        success_flag = True
        for param in params:
